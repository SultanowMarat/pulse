...
curl -s -o /dev/null -w "GET /api/users/me -> %{http_code} (401=норма без сессии, 502=API недоступен)\n" http://127.0.0.1:80/api/users/me 2>/dev/null || echo "curl /api/users/me failed"
